...
export class SaveManager {
    ...
    makeFromSerializableData (obj: any): any {
      if (obj === null) { return null } else if (obj === undefined) { return undefined } else if (typeof (obj) === 'symbol') { return undefined } else if (typeof (obj) === 'function') { return undefined } else if (typeof (obj) === 'number') { return obj } else if (typeof (obj) === 'boolean') { return obj } else if (typeof (obj) === 'string') { return obj } else if (typeof (obj) === 'object') {
        const clsName = obj.__class__
        if (clsName === 'Map') {
          const ret = new Map()
          const members = obj.__data__
          for (const [k, v] of members) {
            if (k !== undefined && v !== undefined) { ret.set(k, v) }
          }
          return ret
    ...
    convertToSerializableData (obj: any): any {
      if (obj === null) { return null } else if (obj === undefined) { return undefined } else if (typeof (obj) === 'symbol') { return undefined } else if (typeof (obj) === 'function') { return undefined } else if (typeof (obj) === 'number') { return obj } else if (typeof (obj) === 'boolean') { return obj } else if (typeof (obj) === 'string') { return obj } else if (obj instanceof Array) {
        const ret = []
