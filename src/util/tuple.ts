...
export const getOrDefault = <T>(o: any, key: string, defaultValue: T): T => {
  ...
  const val = o[key]
  if (typeof (val) === typeof (defaultValue)) { return val } else { return defaultValue }
}
...
export const getString = <T>(o: any, key: string, defaultValue: T): string | T => {
  ...
  const val = o[key]
  if (typeof (val) === 'string') { return val } else { return defaultValue }
}
...
export const getStringOrError = (o: any, key: string, errorString: string): string => {
  ...
  const val = o[key]
  if (typeof (val) === 'string') { return val } else { throw new Error(errorString) }
}
...
export const getNumber = <T>(o: any, key: string, defaultValue: T): number | T => {
  ...
  const val = o[key]
  if (typeof (val) === 'number') { return val } else { return defaultValue }
}
